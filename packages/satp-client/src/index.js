...
module.exports = {
  ...
  TOKEN_PROGRAM_ID: v3pda.TOKEN_PROGRAM_ID,
  ASSOCIATED_TOKEN_PROGRAM_ID: v3pda.ASSOCIATED_TOKEN_PROGRAM_ID,
  getAssociatedTokenPDA: v3pda.getAssociatedTokenPDA,
  deriveAssociatedTokenPda: v3pda.getAssociatedTokenPDA,
  getV3EscrowTokenVaultPDA: v3pda.getV3EscrowTokenVaultPDA,
  deriveEscrowTokenVaultPda: v3pda.getV3EscrowTokenVaultPDA,
