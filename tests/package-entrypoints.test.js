...
for (const [packageName, api, required] of [
  ['@brainai/satp', satp, ['core', 'solana', 'prepareIdentityAttestationRequest', 'buildSatpTrustPacket', 'getV3ProgramIds', 'getGenesisPDA', 'createSATPClient']],
  ['@brainai/satp-core', core, ['prepareIdentityAttestationRequest', 'buildSatpTrustPacket', 'validateSatpTrustPacket', 'evaluateRuntimePolicy']],
  ['@brainai/satp-solana', solana, ['getV3ProgramIds', 'hashAgentId', 'getGenesisPDA', 'createSATPClient']],
]) {
