...
const REPUTATION_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0xb0, 0xb3, 0x8d, 0x6e, 0xa6, 0xc2, 0x56, 0x27, 0xd5, 0x0d, 0x89, 0xf5, 0xc5, 0xcb, 0xe0, 0xd8, 0x62, 0xe1, 0x0d, 0xce, 0x72, 0xda, 0xec, 0x72, 0x2f, 0x02, 0x2f, 0xa9, 0x13, 0xc3, 0x6c, 0x60
]); // CtmZ1fHaypt3R6wbeiGawiRnjzRK9T8jsECk9mET9AK9 (devnet)

#[cfg(not(feature = "devnet"))]
const REPUTATION_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0x13, 0xfa, 0x4b, 0xb6, 0xac, 0xa0, 0x20, 0x45, 0xc5, 0x75, 0x8e, 0x87, 0x24, 0x01, 0xfd, 0xd1, 0xab, 0x0f, 0xba, 0xe3, 0x9a, 0xd1, 0xdd, 0x2b, 0xcc, 0x5a, 0x3d, 0x5a, 0x00, 0x4a, 0xd9, 0x77
]); // 2Lz7KzMvKdrGeAuS8WPHu7jK2yScrnKVgacpYVEuDjkJ (mainnet)


#[cfg(feature = "devnet")]
const VALIDATION_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0xb7, 0x35, 0xb4, 0x49, 0xb8, 0x79, 0x27, 0x29, 0xec, 0xa6, 0xb8, 0xaf, 0xe9, 0xb2, 0x70, 0xd8, 0xff, 0xf9, 0xff, 0xfc, 0xc7, 0xfd, 0xcd, 0x95, 0x76, 0xe5, 0x2b, 0x59, 0x81, 0x86, 0x94, 0x04
]); // DLB76DzAFY8KNuvnP79BZW3cehGreEQTeGDvFCNd2Ekj (devnet)

#[cfg(not(feature = "devnet"))]
const VALIDATION_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0x56, 0xfb, 0x6d, 0x85, 0x2c, 0x92, 0xa5, 0x72, 0x80, 0x0c, 0xe1, 0xe5, 0x2c, 0x3a, 0x32, 0xbd, 0x14, 0xd4, 0xd3, 0x67, 0xbd, 0x6c, 0x61, 0x48, 0x19, 0x0a, 0x13, 0xd8, 0x80, 0x29, 0x23, 0x18
]); // 6rYRiCYidJYV7QvKrzKGgNu4oMh6BAvynked69R7xMbV (mainnet)


#[cfg(feature = "devnet")]
const ATTESTATIONS_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0x3c, 0x9a, 0xdf, 0x48, 0x1a, 0xf8, 0xc8, 0x9d, 0x50, 0x8a, 0x31, 0x18, 0xe8, 0xa7, 0x27, 0xbf, 0xe6, 0x00, 0xff, 0x21, 0x1c, 0x41, 0xf7, 0x6b, 0x3a, 0xaa, 0x1d, 0x2e, 0xce, 0x71, 0x80, 0x3c
]); // 55aS2y5Lhe427iW4cgo2nmZPrxwH3F7BWkw6MnoEm4zw (devnet)

#[cfg(not(feature = "devnet"))]
const ATTESTATIONS_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0x52, 0x22, 0x93, 0x8e, 0x33, 0x1c, 0xee, 0x65, 0x85, 0x32, 0x0e, 0x5d, 0x4c, 0xba, 0x50, 0x43, 0xf7, 0x83, 0xed, 0x32, 0x2f, 0x56, 0x8c, 0x4a, 0x48, 0xff, 0x94, 0xcc, 0x85, 0x75, 0xb0, 0xf0
]); // 6Xd1dAQJPvQRJ4Ntr6LtPTjDjPUZ8nfnmYLZaZ2DtrdD (mainnet)
