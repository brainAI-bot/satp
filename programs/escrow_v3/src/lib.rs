...
/// Identity V3 program ID — cfg-gated to the same cluster as declare_id.
/// Default / mainnet: GTppU4E44BqXTQgbqMZ68ozFzhP1TLty3EGnzzjtNZfG
/// feature = "devnet": 7qmfg4CgiXVDZGBeUkSkMsacKjCRty2xEAugPK4nfvZQ
#[cfg(feature = "devnet")]
const IDENTITY_V3_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0x65, 0xa4, 0x81, 0x5a, 0x60, 0xf7, 0x0f, 0x90, 0x9a, 0xec, 0xa2, 0x2d, 0xe5, 0xac, 0x74, 0xec, 0xd9, 0xf1, 0x16, 0x29, 0xc1, 0x27, 0x41, 0x5e, 0xe9, 0xed, 0xc2, 0x11, 0x52, 0xbf, 0xf0, 0xeb
]); // 7qmfg4CgiXVDZGBeUkSkMsacKjCRty2xEAugPK4nfvZQ (devnet)

#[cfg(not(feature = "devnet"))]
const IDENTITY_V3_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0xe5, 0xbe, 0x79, 0x2d, 0xc0, 0x94, 0x59, 0x73, 0x76, 0xe0, 0x83, 0x33, 0xb8, 0xe8, 0x1b, 0x76, 0x0d, 0xbf, 0x0e, 0x11, 0x92, 0x60, 0x02, 0xc5, 0x48, 0x65, 0x4b, 0x15, 0x4e, 0x63, 0x2a, 0xa3
