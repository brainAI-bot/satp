...
| npm `@brainai/satp-client` | Registry readback on 2026-08-02: `latest` is `2.0.6`, `rc` is `2.0.2`, and published versions are `0.1.0-rc.0`, `2.0.0`, `2.0.1`, `2.0.2`, `2.0.3`, `2.0.4`, `2.0.5`, and `2.0.6`. Owner-approved approval record `REQ-cc84fa3a` and PR #115 remain the publicly auditable approval provenance for the stable package line; HQ task `SATP-NPM-PUBLISH-APPROVAL-EFFECTIVE-20260802` records the 2.0.6 publish/readback. | Stable consumers use `@brainai/satp-client@2.0.6` or `@brainai/satp-client`; reproducible historical rc evidence uses exact `@brainai/satp-client@2.0.2`; `@rc` is only for HQ-assigned moving-tag validation. |
